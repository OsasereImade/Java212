...
public class TwoDimensionArray {
    ...
    public static int [][] fillArray(String filename){
       ...
       //the first two lines are the amount of rows and the column in the array
       //they are converted from a string to an integer.
       line = in.readLine();
       ...
       //nested for loop to assign each line from the file to the next space in the array
       for(int r = 0; r < row; r++) {
           for(int c = 0; c <col; c++) {
               line = in.readLine();
